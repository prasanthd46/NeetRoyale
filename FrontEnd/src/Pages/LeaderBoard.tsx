...
const LeaderBoard = () => {
  ...
  return (
    <div className="bg-black overflow-hidden h-screen text-white">
      <Navbar />
        ...
        <div className="flex flex-col  gap-y-20  items-center ">
          <div className="flex  rounded gap-5  items-center w-[800px] ">
            <div
              ...
              className="w-[60%] relative border border-[#303030]  p-10 px-7 flex gap-10  items-center rounded"
            >
              <span className="absolute top-0 left-0 w-full h-full rounded-xl pointer-events-none z-0">
                {" "}
                <span
                  className={`absolute top-0 left-0 w-1 h-full bg-purple-500 shadow-[0_0_10px_rgba(168,85,247,0.9)] transition-all duration-500 group-hover:h-24 ${
                    flag === true ? "w-16" : ""
                  } `}
                />
              </span>
            ...
            <div className="w-[40%] hover:scale-100  hover:bg-purple-500 hover:shadow-[0_0_10px_rgba(168,85,247,0.9)]  hover:text-white text-md  transition-all  duration-300 flex flex-col justify-center items-center  border border-[#303030]  w-33 h-33 font-normal rounded ">
              Host By
              <div className="font-light">DontKnow</div>
            </div>
          </div>
          ...
          <div className="w-full flex justify-end">
            <button
              ...
              className="text-white bg-purple-400 shadow-[0_0_10px_rgba(168,85,247,0.6)] hover:bg-purple-800   font-medium rounded-lg text-sm outline-none px-5 py-2.5 text-center inline-flex items-center dark:bg-purple-600 dark:hover:bg-purple-700"
            >
              Home
              <svg
